...
with st.sidebar.expander("⚙️ Parameter Settings", expanded=False):
...
if model_choice == "Consumption-Savings":
    ...
    st.sidebar.markdown("<strong style='color:#00d4ff'>⚙️ Model Parameters (Use sliders to adjust)</strong>", unsafe_allow_html=True)
    ...
    if 'cs_model' in st.session_state:
        ...
        with tab3:
            ...
            if st.button("▶️ Run Simulation", key="cs_run_sim", use_container_width=True):
...
# ============================================================================
    ...
    if 'rc_model' in st.session_state:
        ...
        with tab3:
            ...
            if st.button("▶️ Run Simulation", key="rc_run_sim", use_container_width=True):
                with st.spinner("Running simulation..."):
...
# ============================================================================
    ...
    if 'ls_model' in st.session_state:
        ...
        with tab3:
            ...
            if st.button("▶️ Run Simulation", key="ls_run_sim", use_container_width=True):
                with st.spinner("Running simulation..."):
                    sim = model.simulate(T=sim_length, initial_a=initial_a,
                                       random_seed=int(random_seed))
